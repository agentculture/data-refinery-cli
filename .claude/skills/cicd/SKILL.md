...
type: command
description: >
  data-refinery-cli's CI/CD lane, layered on `devex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in data-refinery-cli, handling
...
# CI/CD — data-refinery-cli edition
