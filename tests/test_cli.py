"""Smoke tests for the data-refinery-cli CLI entry point and its verbs."""
...
from data_refinery.explain import known_paths
...
def test_whoami_text(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    assert "nick: data-refinery-cli" in out
...
def test_whoami_json(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    assert payload["nick"] == "data-refinery-cli"
